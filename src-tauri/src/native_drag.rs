...
fn macos_screen_rect_origin(
    ...
    NativeWebviewOrigin {
        ...
        y: (main_screen_height - rect_y - rect_height) * primary_scale_factor,
    }
}
...
pub fn native_webview_origin(
    ...
    let position = webview_window.inner_position().map_err(|error| error.to_string())?;
...
mod tests {
    ...
    fn converts_macos_bottom_left_rect_to_cursor_physical_origin() {
        assert_eq!(
            macos_screen_rect_origin(900.0, 2.0, 100.0, 600.0, 200.0),
